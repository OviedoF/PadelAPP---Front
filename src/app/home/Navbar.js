        ...
        <div className="flex justify-center h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            <Link
              ...
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-cyan-500 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
        ...
        <div className="sm:hidden">
          <div className="pt-2 pb-3 space-y-1">
            ...
            <div className="px-3 py-2">
              <Link
                href="/registro"
                className="block text-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-cyan-500 hover:bg-blue-700"
              >
                <FaSearch className="inline-block w-5 h-5 mr-2" />
                Buscar Jugador
              </Link>
            </div>
          </div>
